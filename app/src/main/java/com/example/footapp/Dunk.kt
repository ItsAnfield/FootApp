...
class Dunk : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        goBrighton.setOnClickListener{
            db.collection("/equipos/C35FcMnIkwzz3tShzbkB/jugadores").document("Gb3YHv8H47krxbIGtmQC").get().addOnSuccessListener {
        ...
        nextBrighton.setOnClickListener{
            val intent = Intent(this, Webster::class.java)

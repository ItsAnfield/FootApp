...
class Duffy : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_duffy)
        ...
        goBrighton.setOnClickListener{
            db.collection("/equipos/C35FcMnIkwzz3tShzbkB/jugadores").document("0aDh86IFvNNQ4iLm7J0V").get().addOnSuccessListener {
        ...
        nextBrighton.setOnClickListener{
            val intent = Intent(this, Haydon::class.java)

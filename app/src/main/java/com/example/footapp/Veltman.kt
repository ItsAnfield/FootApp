...
class Veltman : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_veltman)
        ...
        goBrighton.setOnClickListener{
            db.collection("/equipos/C35FcMnIkwzz3tShzbkB/jugadores").document("0O7H36HhRCCo7HSmNKHR").get().addOnSuccessListener {
        ...
        nextBrighton.setOnClickListener{
            val intent = Intent(this, Duffy::class.java)

...
class Hause : AppCompatActivity() {
    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hause)
        ...
        goVilla.setOnClickListener{
            db.collection("/equipos/lolfkeGassOwIN2YOogh/jugadores").document("TTGci1SCWFoaKNFwVB8a").get().addOnSuccessListener {
        ...
        nextVilla.setOnClickListener {
            val intent = Intent(this, Mings::class.java)

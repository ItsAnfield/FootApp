...
class Steele : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_steele)
        ...
        goBrighton.setOnClickListener{
            db.collection("/equipos/C35FcMnIkwzz3tShzbkB/jugadores").document("2bgNVKYXFTwkmDMxIzCA").get().addOnSuccessListener {
        ...
        nextBrighton.setOnClickListener{
            val intent = Intent(this, rSanchez::class.java)

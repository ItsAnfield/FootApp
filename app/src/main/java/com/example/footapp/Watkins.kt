...
class Watkins : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_watkins)
        ...
        goVilla.setOnClickListener{
            db.collection("/equipos/lolfkeGassOwIN2YOogh/jugadores").document("iFSYZrvEg3etTf2OHqnF").get().addOnSuccessListener {
        ...
        nextVilla.setOnClickListener {
            val intent = Intent(this, Ings::class.java)

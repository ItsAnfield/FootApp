...
class Mwepu : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mwepu)
        ...
        goBrighton.setOnClickListener{
            db.collection("/equipos/C35FcMnIkwzz3tShzbkB/jugadores").document("3q8pOD9PkeB9AyPK2hq1").get().addOnSuccessListener {
        ...
        nextBrighton.setOnClickListener{
            val intent = Intent(this, Alzate::class.java)

...
class Welbeck : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_welbeck)
        ...
        goBrighton.setOnClickListener{
            db.collection("/equipos/C35FcMnIkwzz3tShzbkB/jugadores").document("b9MQLooR35sPcykYfpVF").get().addOnSuccessListener {

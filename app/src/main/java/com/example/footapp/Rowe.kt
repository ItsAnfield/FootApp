...
class Rowe : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_rowe)
        ...
        arsenalGO4.setOnClickListener{
            db.collection("/equipos/aMjroQ5RT68MuT7CKINl/jugadores").document("m70CgDdT4LV1SLhoBtxW").get().addOnSuccessListener {
        ...
        btnNextArsenal4.setOnClickListener{
            val intent = Intent(this, Elneny::class.java)

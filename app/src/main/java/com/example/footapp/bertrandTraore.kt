...
class bertrandTraore : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bertrand_traore)
        ...
        goVilla.setOnClickListener{
            db.collection("/equipos/lolfkeGassOwIN2YOogh/jugadores").document("RIdFOJPjpS4QbPxjrOPN").get().addOnSuccessListener {
        ...
        nextVilla.setOnClickListener {
            val intent = Intent(this, Watkins::class.java)

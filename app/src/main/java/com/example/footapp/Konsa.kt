...
class Konsa : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_konsa)
        ...
        goVilla.setOnClickListener{
            db.collection("/equipos/lolfkeGassOwIN2YOogh/jugadores").document("WyAyqRxWOuVGPzgrXCw7").get().addOnSuccessListener {
        ...
        nextVilla.setOnClickListener {
            val intent = Intent(this, Chambers::class.java)

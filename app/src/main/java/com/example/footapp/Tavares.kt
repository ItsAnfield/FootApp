...
class Tavares : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tavares)
        ...
        arsenalGO4.setOnClickListener{
            db.collection("/equipos/aMjroQ5RT68MuT7CKINl/jugadores").document("ViTDyuGGX5TOgRO27vH6").get().addOnSuccessListener {
        ...
        btnNextArsenal4.setOnClickListener{
            val intent = Intent(this, Gabriel::class.java)

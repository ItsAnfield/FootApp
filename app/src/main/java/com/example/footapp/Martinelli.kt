...
class Martinelli : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_martinelli)
        ...
        arsenalGO4.setOnClickListener{
            db.collection("/equipos/aMjroQ5RT68MuT7CKINl/jugadores").document("cI0KeACiNWEaGfw7hYVs").get().addOnSuccessListener {
        ...
        btnNextArsenal4.setOnClickListener{
            val intent = Intent(this, Saka::class.java)

...
class Chukwuemeka : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chukwuemeka)
        ...
        goVilla.setOnClickListener{
            db.collection("/equipos/lolfkeGassOwIN2YOogh/jugadores").document("ZnTaIEMwK3I2MZqFlqD5").get().addOnSuccessListener {
        ...
        nextVilla.setOnClickListener {
            val intent = Intent(this, McGinn::class.java)

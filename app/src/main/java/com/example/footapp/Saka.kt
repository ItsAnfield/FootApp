...
class Saka : AppCompatActivity() {

    val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_saka)
        ...
        arsenalGO4.setOnClickListener{
            db.collection("/equipos/aMjroQ5RT68MuT7CKINl/jugadores").document("dKeybQRWBFUOMjMChdw4").get().addOnSuccessListener {
        ...
        btnNextArsenal4.setOnClickListener{
            val intent = Intent(this, Nketiah::class.java)
